 ...
 */
#define GET_FIELD(thisTypeName, fieldTypeName, classValue, fieldName) (GET_STRUCT_FIELD(fieldTypeName,CLASS_CAST(TO_CLASS_PTR(classValue,thisTypeName),thisTypeName,fieldTypeName) ,struct TypedValue*,m_##fieldTypeName##_##fieldName))
 ...
 * Macro to obtain a field from a (sub-)class specific class struct. We clone to preserve value semantics and the rule of freeing
 */
#define GET_FIELD_PTR(thisTypeName, fieldTypeName, ptr, fieldName) (GET_STRUCT_FIELD(fieldTypeName,CLASS_CAST(ptr,thisTypeName,fieldTypeName) ,struct TypedValue*,m_##fieldTypeName##_##fieldName))
